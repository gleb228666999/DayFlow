...
def add_activity():
    ...
    akt = int(input("Выберите категорию активности (1-5): "))
    akt = categories.get(akt, "Неизвестно")


    time_task = input(random.choice(time_prompts))
    save_activity(
        category=akt,
        duration=int(min_format(time_task)) / 60,
...
def help_section():
    print("1. формат времени при указании времени активности ЧЧ:ММ")
